...
public class ChallengeSubMenu : MonoBehaviour {
	...
	void Start () {
        ...
        advMenu = GameObject.Find("EventSystem").GetComponent<RacePrep>();
        advMenu.charPrep[myNumber] = gameObject;
        advMenu.charPrepScript[myNumber] = GetComponent<CharacterPrep>();
